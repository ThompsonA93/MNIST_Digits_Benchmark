...
txt_out_file_path = 'svm-pca-parameter-tuning-log.txt'
...
clf = SVC()
clf.fit(pca_train_data, train_label)

print('score', clf.score(pca_train_data, train_label))
print('pred label', clf.predict(pca_train_data))
